...
public class ConnectLinkCodeResponseDTO {
    ...
    private String userId1;          // 사용자 1 (코드 발급자)
    private String userId2;          // 사용자 2 (코드 입력자)
    private LocalDateTime connectedDt;  // 커플 연결 일자

    public static ConnectLinkCodeResponseDTO of(Long coupleId, String userId1, String userId2, LocalDateTime connectedDt) {
